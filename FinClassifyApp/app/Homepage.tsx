...
import { View, Text, TouchableOpacity, StyleSheet, Image, Modal, FlatList, Animated, Dimensions } from "react-native";
...
const styles = StyleSheet.create({
    ...
    headerContainer: { backgroundColor: "#0F730C", padding: 15, flexDirection: "row", justifyContent: "space-between", alignItems: "center" },
    menuIcon: { padding: 5 },
    headerTitle: { color: "white", fontSize: 18, fontWeight: "bold" },
    searchIcon: { padding: 5 },
    dateAndStatsContainer: { backgroundColor: "#0F730C", padding: 15, flexDirection: "row", justifyContent: "space-between", alignItems: "center" },
    ...
    statValue: { color: "white", fontSize: 14, fontWeight: "bold", textAlign: 'center' },
    content: { flex: 1, justifyContent: "center", alignItems: "center", padding: 20 },
    image: { width: 80, height: 80, marginBottom: 10 },
    noRecordText: { fontSize: 14, color: "#555", textAlign: "center" },
    fab: { position: "absolute", bottom: 70, right: 20, backgroundColor: "#0F730C", width: 50, height: 50, borderRadius: 25, justifyContent: "center", alignItems: "center", shadowColor: "#000", shadowOpacity: 0.3, shadowOffset: { width: 0, height: 3 } },
    bottomNav: { flexDirection: "row", justifyContent: "space-around", padding: 10, borderTopWidth: 1, borderColor: "#ddd", backgroundColor: "white" },
    ...
    menuContainer: { backgroundColor: 'white', width: width * 0.7, padding: 20, marginTop: 60 },
