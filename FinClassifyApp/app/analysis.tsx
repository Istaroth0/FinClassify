// c:\Users\scubo\OneDrive\Documents\FC_proj\FinClassify\FinClassifyApp\app\analysis.tsx
...
const formatCurrency = (amount: number): string => {
  ...
  // Use Math.abs to always show a positive value in the summary
...
function AnalysisScreen() {
  ...
  // --- Handler for tapping a category to expand/collapse ---
    ...
    return (
      ...
      <View style={styles.itemWrapper}>
        <TouchableOpacity
          ...
          // Update onPress to use the category name
  ...
  const renderContent = () => {
    ...
    const totalExpenses = categorySpendingData.reduce(
    ...
    return (
      <FlatList
        ...
        ListHeaderComponent={
          // Add a header to show the total
          <View style={styles.totalExpensesContainer}>
            <Text style={styles.totalExpensesLabel}>
              Total Expenses ({selectedMonth} {selectedYear}):
            </Text>
