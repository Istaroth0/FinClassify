...
const DEFAULT_ICONS: Array<{
  ...
  { name: "cash", key: "salary" },
  { name: "trophy", key: "awards" },
  { name: "ticket", key: "lottery" },
  { name: "credit-card-refund", key: "refunds" },
  { name: "home-city", key: "rental" },
  { name: "tag", key: "sale" },
  { name: "gift", key: "gifts" },
  { name: "currency-usd", key: "investment" },
  { name: "chart-line", key: "dividend" },
];
...
AddCategoryModalProps) {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const categoryDocRef = doc(db, "Accounts", userId, "Income", trimmedName);
      ...
      console.error("Error saving income category to Firestore:", error);
      if (error.code === "permission-denied") {
        Alert.alert(
          "Permission Error",
          "You don't have permission to save this income category."
        );
      } else {
    ...
    >
      <View style={styles.modalContainer}>
        <View style={styles.modalContent}>
          <Text style={styles.title}>Add New Income Category</Text>
